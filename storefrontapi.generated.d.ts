...
export type BrandMoneyFragment = Pick<
  StorefrontAPI.MoneyV2,
  'amount' | 'currencyCode'
>;

export type BrandVariantProductFragment = Pick<
...
export type BrandSearchProductsQueryVariables = StorefrontAPI.Exact<{
...
export type BrandFeaturedProductQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
  handle: StorefrontAPI.Scalars['String']['input'];
}>;

export type BrandFeaturedProductQuery = {
...
export type BrandEditorialProductQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
  handle: StorefrontAPI.Scalars['String']['input'];
}>;

export type BrandEditorialProductQuery = {
  product?: StorefrontAPI.Maybe<
    Pick<
      StorefrontAPI.Product,
...
export type BrandCollectionProductFragment = Pick<
  StorefrontAPI.Product,
  'id' | 'handle' | 'title' | 'vendor'
> & {
  featuredImage?: StorefrontAPI.Maybe<
...
export type BrandCollectionQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
  handle: StorefrontAPI.Scalars['String']['input'];
  first: StorefrontAPI.Scalars['Int']['input'];
...
export type HomeRowMoneyFragment = Pick<
  StorefrontAPI.MoneyV2,
  'amount' | 'currencyCode'
>;

export type HomeRowProductCardFragment = Pick<
  StorefrontAPI.Product,
  'id' | 'handle' | 'title' | 'vendor'
> & {
  featuredImage?: StorefrontAPI.Maybe<
...
export type CollectionMenuItemFieldsFragment = Pick<
  StorefrontAPI.MenuItem,
  'id' | 'resourceId' | 'title' | 'type' | 'url'
>;

export type CollectionMenuItemLevel4Fragment = Pick<
  StorefrontAPI.MenuItem,
  'id' | 'resourceId' | 'title' | 'type' | 'url'
>;

export type CollectionMenuItemLevel3Fragment = Pick<
  StorefrontAPI.MenuItem,
  'id' | 'resourceId' | 'title' | 'type' | 'url'
> & {
  items: Array<
    Pick<StorefrontAPI.MenuItem, 'id' | 'resourceId' | 'title' | 'type' | 'url'>
  >;
};

export type CollectionMenuItemLevel2Fragment = Pick<
  StorefrontAPI.MenuItem,
  'id' | 'resourceId' | 'title' | 'type' | 'url'
> & {
  items: Array<
...
export type CollectionMenuItemLevel1Fragment = Pick<
  StorefrontAPI.MenuItem,
  'id' | 'resourceId' | 'title' | 'type' | 'url'
> & {
  items: Array<
...
> & {
  availability?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
  images: {
    nodes: Array<
      Pick<StorefrontAPI.Image, 'id' | 'url' | 'altText' | 'width' | 'height'>
    >;
...
export type ProductQuery = {
  product?: StorefrontAPI.Maybe<
    Pick<
      ...
      | 'encodedVariantAvailability'
    > & {
      availability?: StorefrontAPI.Maybe<
